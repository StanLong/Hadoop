...
<configuration>
    ...
    <property>
        ...
        <value>/var/data/yarn/jobhistory/done_intermediate</value>
    </property>

    <!-- 运行过的日志存放在hdfs上的存放路径 -->
    <property>
        <name>mapreduce.jobhistory.done-dir</name>
        <value>/var/data/yarn/jobhistory/done</value>
    </property>
...
# 新建一个PID目录
[root@node02 pid]# pwd
/opt/stanlong/hadoop/hadoop-2.9.2/pid

[root@node02 sbin]# pwd
/opt/stanlong/hadoop/hadoop-2.9.2/sbin
...
# 修改后
if [ "$HADOOP_PID_DIR" = "" ]; then
  HADOOP_PID_DIR="/opt/stanlong/hadoop/hadoop-2.9.2/pid"
fi
```
